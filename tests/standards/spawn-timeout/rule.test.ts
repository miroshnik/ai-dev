 ...
 * и git в разы, и тест на секунду идёт 5–15 с. Падение по таймауту тогда ложное — гонки и ожидания событий нет, тест
 * детерминирован; таймаут 30 с ловит только зависание.
 */
...
// package.json не видит голый `bun test`.
